...
- Всё инлайн; без фреймворков/сборки/CDN. Главная self-hosts шрифты из `assets/fonts/`; на внутренних страницах пока допустим Google Fonts. Из runtime-внешнего — Яндекс.Метрика. Палитра/бренд/позиционирование не менять без подтверждения.
