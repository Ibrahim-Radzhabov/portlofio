...
const INJECTED_STYLES = `
  ...
  .preloader-percentage {
    ...
    font-family: monospace; font-size: 1.5rem; color: rgba(255,255,255,0.4);
  }
...
export function CinematicHero({ 
  ...
  useEffect(() => {
    ...
    const tl = gsap.to({}, {
      ...
      onComplete: () => {
        ...
        exitTl
          .to(".preloader-text", { y: -100, autoAlpha: 0, duration: 1, ease: "expo.inOut" })
  ...
  // 3. Cinematic Scroll Timeline (starts only after loading)
  useEffect(() => {
    if (loading) return;
    ...
    >
      ...
      {loading && (
        <div ref={preloaderRef} className="preloader-container">
          <h2 className="preloader-text">{brandName}</h2>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none">
            <svg className="w-8 h-8 transition-transform group-hover:scale-105" fill="currentColor" viewBox="0 0 384 512">
          ...
          <a href="#" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none">
            <svg className="w-7 h-7 transition-transform group-hover:scale-105" fill="currentColor" viewBox="0 0 512 512">
